package com.xiangjing.mybatisplus;
...
public class GeneratorTest {
    ...
    //输出目录
    private String outputDir="D:\\ideaProjects\\xiangjing\\learn\\mybatis-plus\\src\\main\\";
    //输出目录
    private String outputCodeDir="D:\\ideaProjects\\xiangjing\\learn\\mybatis-plus\\src\\main\\java\\";
    ...
    public void generate_mp(){
        FastAutoGenerator.create(url, username, password)
                ...
                .packageConfig(builder -> {
                    builder.parent("com.xiangjing.mybatisplus") // 设置父包名
...
//                            .addTablePrefix("t_", "c_"); // 设置过滤表前缀
    ...
    public void test() {
        ...
        String encryptUrl = basicTextEncryptor.encrypt(url);
        String encryptUsername = basicTextEncryptor.encrypt(username);
        String encryptPassword = basicTextEncryptor.encrypt(password);
        log.info("encryptUrl[ENC({})]",encryptUrl);
        log.info("encryptUsername[ENC({})]",encryptUsername);
        log.info("encryptPassword[ENC({})]",encryptPassword);
    }
}

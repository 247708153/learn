...
public class GeneratorTest {
    ...
    //输出目录
    private String outputDir="D:\\ideaProjects\\xiangjing\\learn\\transactional\\src\\main\\";
    //输出目录
    private String outputCodeDir="D:\\ideaProjects\\xiangjing\\learn\\transactional\\src\\main\\java\\";

    /**
     * 数据源配置
     */
    @Test
    public void generate_trans(){
        FastAutoGenerator.create(url, username, password)
                ...
                .packageConfig(builder -> {
                    builder.parent("com.xiangjing.transactional") // 设置父包名
